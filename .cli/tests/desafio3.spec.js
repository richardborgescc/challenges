...
describe('Item 1', () => {
  ...
  it('Funcão "showNumbers" deve mostrar os valores 1,2,3,4 e 5, quando passado o número 5 como parametro', () => {
    ...
    expect(global.console.log.mock.calls[1][0]).toBe(1);
    expect(global.console.log.mock.calls[2][0]).toBe(2);
    expect(global.console.log.mock.calls[3][0]).toBe(3);
    expect(global.console.log.mock.calls[4][0]).toBe(4);
  });
